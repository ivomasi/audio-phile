...
function ProductCard({ model, brand, price, stock = 12, sold }) {
	...
	return (
		<Card>
			...
			{<Button primary style={{backgroundColor: stock !== 0 ? null : colors.grey}} rounded text={stock !== 0 ? "add to cart" : "OUT OF STOCK"} size="lg" width="100%" disabled={stock !== 0 ? false : true }/>}
